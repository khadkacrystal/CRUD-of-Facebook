...
# refresh_button.grid(anchor='center',row=0,column=0)
...
# Create label box
details = Label(root, text="Details", font=("Arial Bold", 20))
...
edit_box_label = Label(root, text="Edit")
